...
public class HeliumBundleFactory {
  ...
  private static final String NODE_VERSION = "v10.24.1";
  private static final String NPM_VERSION = "6.14.12";
      ...
      for (boolean last = (line == null); !last; line = next) {
        ...
        if (!webpackRunDetected) {
          ...
          if (trimed.contains("webpack")
              && (trimed.endsWith("--json") || trimed.endsWith("--json --registry=https://registry.npmjs.org/"))) {
